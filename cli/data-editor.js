  ...
  **/
  ...
  add: function(folder, route) {
    ...
    if (idx > -1)
      ...
      editor.save();
      console.log("   " + chalk.cyan("Added:") + " leadship now includes " + chalk.yellow(folder) + " in your data directory");
    }
  ...
  **/
  ...
  remove: function(folder) {
    ...
    if (idx === -1) {
      ...
      editor.set("data", data);
      editor.save();
      console.log("   " + chalk.cyan("Removed:") + " leadship no longer includes " + chalk.yellow(folder) + " in your data directory");
    }
